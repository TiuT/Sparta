...
#pragma mark - 拉伸图片
+ (instancetype)sp_resizingImage:(NSString *)imageName {
...
#pragma mark - 禁止渲染
+ (instancetype)sp_imageOriginalWithName:(NSString *)imageName {
...
+ (instancetype)sp_imageWithClipImageNamed:(NSString *)clipImageName borderWidth:(CGFloat)borderWidth borderCorlor:(UIColor *)borderColor {
...
#pragma mark - 颜色生成图片
+ (instancetype)sp_imageWithColor:(UIColor *)color {
...
#pragma mark - 控件截图
+ (instancetype)sp_imageWithCaptureView:(UIView *)view {
