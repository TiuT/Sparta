...
+ (void)initialize {
    ...
    UINavigationBar *navigationBar = [UINavigationBar appearanceWhenContainedInInstancesOfClasses:@[[SPNavigationController class]]];
    
    // 设置背景图片
    navigationBar.barTintColor = SPGlobalBg;
